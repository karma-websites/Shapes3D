...
namespace Scene
{
    ...
    {
        public void RenderMesh(OpenGL gl, List<TriangulatedFace> triangles)
        {
            ...
            foreach (var triangle in triangles)
            {
                ...
                Vector3 normal = Algorithms.GetNormal(point1, point2, point3);
        ...
        public void DrawVertex(OpenGL gl, List<Vector3> vertexes)
        {
