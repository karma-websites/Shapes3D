...
namespace Scene
{
    internal static class Algorithms
    {
        ...
        // Метод преобразует массив вершин с использованием текущей модельно-видовой матрицы OpenGL
        ...
        // Метод для нахождения точек конуса внутри куба и точек куба внутри конуса
        ...
        // Метод для проверки, находится ли точка внутри куба
        ...
        // Метод для нахождения уравнений плоскостей куба
        ...
        // Метод для нахождения уравнений плоскостей конуса
        ...
        // Метод возврвщает точку пересечения отрезка с плоскостью треугольника
